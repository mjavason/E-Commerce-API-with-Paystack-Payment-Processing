...
export class ActivityController {
  ...
  private dummyUserActivity: any[] = [
    {
      userId: '6541bccf70101a35308b8c8d',
      action: 'Viewed MacBook Pro',
      timestamp: '2023-11-02T09:00:00Z',
    },
    {
      userId: '6541bccf70101a35308b8c8d',
      action: 'Added Dell XPS 13 to Cart',
      timestamp: '2023-11-02T09:15:00Z',
    },
    {
      userId: '6541bccf70101a35308b8c8d',
      action: 'Purchased Logitech MX Master 3',
      timestamp: '2023-11-02T09:30:00Z',
    },
    {
      userId: '6541bccf70101a35308b8c8d',
      action: 'Viewed Samsung 49-Inch Ultrawide Monitor',
      timestamp: '2023-11-02T09:45:00Z',
    },
    {
      userId: '6541bccf70101a35308b8c8d',
      action: 'Added Apple AirPods Pro to Cart',
      timestamp: '2023-11-02T10:00:00Z',
    },
    {
      userId: '6541bccf70101a35308b8c8d',
      action: 'Removed HP Spectre x360 from Cart',
    ...
    },
    {
      ...
      timestamp: '2023-11-02T11:00:00Z',
    },
    {
      userId: '6541bccf70101a35308b8c8d',
      action: 'Scheduled Email Newsletter',
  ...
  @ApiOperation({
    summary:
      'Get a list of all user activities for a specific user with pagination',
  })
  async getAllForUser(
    @Param('userId') userId: string,
    @Param('pagination') pagination: string,
  ): Promise<IResponseData<any[]>> {
    if (!userId) {
      throw new NotFoundException();
    }

    const userActivities = this.dummyUserActivity.filter(
